...
/**
  * Base class for data structures that contain multiple elements, such as Vec and Bundle.
...
abstract class MultiData extends Data {
    ...
    // This method allows for adding a tag to this MultiData and all of its elements
    ...
    override def addTag[T <: SpinalTag](spinalTag: T): this.type = {
        // Add the tag to this MultiData
        super.addTag(spinalTag)
        // Add the tag to all elements of this MultiData
    ...
    */
    ...
    /**
    * Convert this MultiData to a Bits instance.
    * @return A Bits instance representing the same data as this MultiData.
    */
    ...
    /**
    * Get the total width in bits of this MultiData.
    ...
    */
    override def getBitsWidth: Int = {
      ...
      /**
    * Set the direction of this MultiData and all its elements to input.
    * @return The current instance with its direction set to input.
    */
    override def asInput(): this.type = {
        // Set the direction of this MultiData to input
        super.asInput()
    ...
    /**
    * Set the direction of this MultiData and all its elements to output.
    * @return The current instance with its direction set to output.
    */
    override def asOutput(): this.type = {
        // Set the direction of this MultiData to output
        super.asOutput()
    ...
    /**
    * Set the direction of this MultiData and all its elements to in/out.
    * @return The current instance with its direction set to in/out.
    */
    override def asInOut(): this.type = {
        // Set the direction of this MultiData to in/out
        super.asInOut()
    ...
    /**
    * Copy the direction of another Data to this MultiData and all its elements.
    ...
    */
    override def copyDirectionOfImpl(that : Data): this.type = {
        // Copy the direction of the other Data to this MultiData
        super.copyDirectionOfImpl(that)
        // Copy the direction of the other Data's elements to this MultiData's elements
      ...
      /**
    * Set the direction of this MultiData and all its elements to directionless.
    * @return The current instance with its direction set to directionless.
    */
    override def setAsDirectionLess(): this.type = {
        // Set the direction of this MultiData to directionless
    ...
    */
    ...
    /**
    * Freeze this MultiData and all its elements.
    ...
    */
    ...
    /**
    * Unfreeze this MultiData and all its elements.
    ...
    */
    override def unfreeze(): MultiData.this.type = {
      ...
      /**
    * Flatten this MultiData into a sequence of BaseType instances.
    ...
    */
    ...
    /**
    * Apply a function to each BaseType in the flattened version of this MultiData.
    ...
    */
    ...
    /**
    * Get the local names of all BaseType instances in the flattened version of this MultiData.
    ...
    */
    ...
    /**
    * Assign values to this MultiData and all its elements from a Bits instance.
    ...
    */
    ...
    /**
    * Assign values to this MultiData and all its elements from a range of a Bits instance.
    * @param bits The Bits instance to assign values from.
    ...
    */
    override def assignFromBits(bits: Bits, hi: Int, lo: Int): Unit = {
        ...
        // Iterate over each element in the MultiData
        for ((_, e) <- elements) {
      ...
      /**
    * Check if this MultiData is equal to another object.
    * @param that The object to compare with.
    * @return A Bool indicating whether this MultiData is equal to the other object.
    */
    private[core] def isEqualTo(that: Any): Bool = {
        that match {
            // If the other object is a MultiData, compare each pair of corresponding elements
            case that: MultiData => {
            ...
            // If the other object is not a MultiData, throw an error
            case _ => SpinalError(s"Function isEqualTo is not implemented between $this and $that")
        }
    }

    /**
        * Check if this MultiData is not equal to another object.
        * @param that The object to compare with.
        * @return A Bool indicating whether this MultiData is not equal to the other object.
        */
    ...
    /**
    * Automatically connect this MultiData to another Data.
    ...
    */
    private[core] override def autoConnect(that: Data)(implicit loc: Location): Unit = {
        that match {
            // If the other Data is a MultiData, auto-connect each pair of corresponding elements
            case that: MultiData => zippedMap(that, _ autoConnect _)
            // If the other Data is not a MultiData, throw an error
            case _ => SpinalError(s"Function autoConnect is not implemented between $this and $that")
        }
    }

    /**
    * Get a string representation of all elements in this MultiData.
    * @return A string representation of all elements.
    */
    def elementsString = this.elements.map(_.toString()).reduce(_ + "\n" + _)

    /**
    * Apply a function to each pair of corresponding elements in this MultiData and another MultiData.
    * @param that The other MultiData.
    ...
    */
    private[core] def zippedMap[T](that: MultiData, task: (Data, Data) => T): Seq[T] = {
        // If the other MultiData doesn't have the same number of elements as this MultiData, throw an error
        ...
        // For each element in this MultiData, find the corresponding element in the other MultiData and apply the function to them
        this.elements.map(x => {
            val (n, e) = x
            val other = that.find(n)
            // If the other MultiData doesn't have an element with the same name as the current element, throw an error
            if (other == null) {
      ...
      /**
    * Get a zero value of this MultiData.
    * @return A new MultiData of the same type as this MultiData, with all elements set to zero.
    */
    override def getZero: this.type = {
        // Create a clone of this MultiData
    ...
    /**
    * Flip the direction of this MultiData and all its elements.
    ...
    */
    override def flip(): this.type  = {
        ...
        // Flip the direction of this MultiData
        dir match {
            case `in`  => dir = out
            case `out` => dir = in
      ...
      /**
    * Assign values to unassigned elements of this MultiData from corresponding elements of another MultiData.
    * @param that The other MultiData to assign values from.
    */
    def assignUnassignedByName(that: MultiData): Unit = {
        // For each pair of corresponding elements in this MultiData and the other MultiData
        // If the element in this MultiData is unassigned and its direction is either directionless, output in the current component, or input in the parent component
        // Assign the value of the element in the other MultiData to the element in this MultiData
    ...
    /**
    * Pair up elements of this MultiData and another MultiData by name.
    * @param that The other MultiData to pair up with.
    ...
    */
    def zipByName(that: MultiData, rec : ArrayBuffer[(BaseType, BaseType)] = ArrayBuffer()): ArrayBuffer[(BaseType, BaseType)] = {
        // For each element in this MultiData, find the corresponding element in the other MultiData by name
        // If the element in this MultiData is a MultiData, recursively pair up its elements with the elements of the corresponding MultiData in the other MultiData
        // If the element in this MultiData is a BaseType, add a pair of it and the corresponding BaseType in the other MultiData to the ArrayBuffer
    ...
    /**
    * Assign a formal random value to each element of this MultiData.
